    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center mt-10">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight animate-fadeIn drop-shadow-xl">
            공의 궤적을 지배하라.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-purple-200">슈팅 마스터, 방성윤과 함께.</span>
          </h1>
          <p className="text-lg md:text-xl text-white font-medium mb-10 max-w-2xl mx-auto drop-shadow-lg bg-black/10 backdrop-blur-sm p-4 rounded-xl border border-white/10">
            슈팅은 과학입니다. 당신의 열정을 결과로 증명할 수 있도록,<br className="hidden md:block"/>
            대한민국 최고의 슈터가 설계한 커리큘럼과 독보적인 커뮤니티가 기다립니다.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" onClick={() => navigate('/clinic')} className="shadow-purple-500/50">슈팅 클리닉 시작하기</Button>
            <Button size="lg" variant="secondary" onClick={() => navigate('/forum')} className="shadow-yellow-500/50">슈터스 포럼 바로가기</Button>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-purple-50 p-6 rounded-xl border-l-4 border-primary shadow-sm">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[500px] border-4 border-white ring-1 ring-gray-100">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                <p className="font-bold text-lg">"Nothing but Net"</p>
                <p className="text-sm opacity-90">정확한 메커니즘이 만드는 완벽한 궤적</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:-translate-y-2 transition-transform duration-300 border border-purple-50/50">
      ...
      <section className="py-24 bg-dark text-white relative overflow-hidden">
        <div className="absolute inset-0">
            <img 
              src="https://images.unsplash.com/photo-1519861531473-920026393112?auto=format&fit=crop&q=80&w=1600" 
              className="w-full h-full object-cover opacity-30" 
              alt="Background" 
            />
            <div className="absolute inset-0 bg-gradient-to-r from-primary/90 to-purple-900/90 mix-blend-multiply"></div>
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-5xl font-bold text-white mb-4 drop-shadow-md">15,000+</h2>
              <p className="text-xl text-purple-100">론칭 6개월 만에 달성한<br/>누적 열혈 슈터 수</p>
            </div>
            <div className="bg-white/10 p-8 rounded-2xl backdrop-blur-md text-left border border-white/10 shadow-2xl">
              ...
              <p className="text-lg italic mb-6 text-white leading-relaxed">
                "방성윤 코치님 클리닉 후 3점 슛 성공률이 18%에서 35%로 두 배 가까이 뛰었습니다. 특히 포럼에서 얻는 동기 부여가 최고예요!"
              </p>
              <div className="font-bold text-purple-200">- 열혈 슈터 '농잘알K'님</div>
            </div>
          </div>
        </div>
      </section>
